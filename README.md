...
3- The project makes use of local empty database to create its tables and constraints. On pgAdmin create an empty database named Library (username: postgres, password:0000, port:5432). To change the name or the credentials for the used database look the application.properties file.\
