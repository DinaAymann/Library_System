...
3- The project makes use of local empty database to create its tables and constraints. On pgAdmin create an emty database Library (username: postgre, password:0000). To change the name or the credentials for the used database look the application.properties file. 
